...
const AssetRow = ({ symbol, color, price, change, chartData, highestPrice, lowestPrice, marketCap }) => {
    ...
    return (
        <Flex align="center" justify="space-between" className={styles.row}>
            <Flex className={styles.rowLeft}>
                ...
                <div className={cx(styles.currencyCode, { tight: symbol.length >= 5 })}>{symbol}</div>
            ...
            <Flex className={styles.rowRight} align="center">
                <div className={styles.chart}>
                    <Line width={125} height={42} data={chartData} options={chartOptions} redraw />
                </div>
