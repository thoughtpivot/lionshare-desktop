                    ...
                    <Flex align="center" justify="center" className={styles.overlay}>
                        <Flex column align="center" className={styles.overlayWrapper}>
                            <Flex align="center" justify="center" className={styles.overlayImage}>
                                <Pie height={87} width={87} data={this.state.chartData} options={chartOptions} />
                                <svg
                            ...
                            <div className={styles.overlayText}>
                                Enter the amount of each digital currency you own (or want to), then{" "}
                                <span className={styles.emphasis}>save</span> to start tracking.
                            </div>
                            <div role="button" className={styles.overlayButton} onClick={toggleOnboarding}>
                                Got it
                            </div>
                        </Flex>
                    </Flex>
...
class EditRow extends React.Component {
    ...
    render() {
        ...
        return (
            <Flex justify="space-between" className={styles.row} onClick={this.onClick}>
